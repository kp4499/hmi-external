import { TestAppComponent } from './components/test-app-external/test-app-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, TestAppComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, TestAppComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
