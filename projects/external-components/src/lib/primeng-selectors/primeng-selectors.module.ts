import { Testai1Component } from './components/testai1-external/testai1-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, Testai1Component],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, Testai1Component],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
