import { EmicalcComponent } from './components/emicalc-external/emicalc-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, EmicalcComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, EmicalcComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
