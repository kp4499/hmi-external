import { WeatherAppDemoComponent } from './components/weather-app-demo-external/weather-app-demo-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, WeatherAppDemoComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, WeatherAppDemoComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
