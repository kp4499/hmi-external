import { TempCalcComponent } from './components/tempCalc-external/tempCalc-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, TempCalcComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, TempCalcComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
